...
export ORDER_CACHE_REFRESH_THRESHOLD="${ORDER_CACHE_REFRESH_THRESHOLD:-1}"
export ORDER_CACHE_REFRESH_WINDOW_SECONDS="${ORDER_CACHE_REFRESH_WINDOW_SECONDS:-30}"
export CACHE_EVENT_DEDUP_TTL_SECONDS="${CACHE_EVENT_DEDUP_TTL_SECONDS:-300}"
